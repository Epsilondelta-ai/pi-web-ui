...
async function fetchLiveSnapshotWithDeps(
  ctx: ExtensionContext,
  deps: KimiFetchDeps,
): Promise<KimiQuotaSnapshot> {
...
function buildKimiRequestHeaders(
...
function detectKimiProviderKind(
...
function mapKimiBalancePayload(
...
function mapKimiCodeUsagePayload(
...
function formatKimiQuotaFooterText(
...
function formatKimiBalanceFooterText(
  snapshot: KimiQuotaSnapshot,
): string | undefined {
