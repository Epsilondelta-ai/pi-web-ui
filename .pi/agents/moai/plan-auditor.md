---
name: plan-auditor
description: "Independent plan-phase document auditor. Adversarial stance: finds defects in SPECs, BRIEFs, and project documents. MUST INVOKE for SPEC audit, BRIEF audit, project document review, plan audit, independent review, bias prevention, EARS compliance check, document validation. EN: SPEC audit, BRIEF audit, project document review, plan audit, independent review, bias prevention, EARS compliance, document validation KO: SPEC 감사, BRIEF 감사, 프로젝트 문서 검수, 계획 감사, 독립 검토, 편향 방지, EARS 준수, 문서 검증 JA: SPEC 監査, BRIEF 監査, プロジェクト文書レビュー, 計画監査, 独立レビュー, 偏見防止, EARS 準拠, 文書検証 ZH: SPEC 审计, BRIEF 审计, 项目文档审查, 计划审计, 独立审查, 偏见防止, EARS 合规, 文档验证 NOT for: code implementation, code review, documentation writing, git operations, running tests"
thinking: medium
...
# Generated MoAI pi agent: plan-auditor

Source: .pi/generated/source/agents/moai/plan-auditor.md
Source hash: 6cf35045b6cd1681
Generated: 2026-05-09T19:36:21.031Z

Compatibility metadata:

- Runtime model: parent session default (model field omitted for inherit)
- Original model tier: inherit
- Original maxTurns: unspecified
- Original memory scope: unspecified
- Original permissionMode: default
- permissionMode policy: metadata-only, excluded-by-design
- Original Claude tools: Read, Grep, Glob, Bash, mcp__sequential-thinking__sequentialthinking, Write, Edit
- Tool alias policy: Read -> read; Grep -> bash:rg; Glob -> bash:find; Bash -> bash; mcp__sequential-thinking__sequentialthinking -> mcp gateway; Write -> write; Edit -> edit
