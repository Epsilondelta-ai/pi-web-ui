...
description: "Security analysis specialist. Use PROACTIVELY for OWASP, vulnerability assessment, XSS, CSRF, and secure code review. MUST INVOKE when ANY of these keywords appear in user request: --deepthink flag: Activate Sequential Thinking MCP for deep analysis of security threats, vulnerability patterns, and OWASP compliance. EN: security, vulnerability, OWASP, injection, XSS, CSRF, penetration, audit, threat KO: 보안, 취약점, OWASP, 인젝션, XSS, CSRF, 침투, 감사, 위협 JA: セキュリティ, 脆弱性, OWASP, インジェクション, XSS, CSRF, ペネトレーション, 監査 ZH: 安全, 漏洞, OWASP, 注入, XSS, CSRF, 渗透, 审计 NOT for: general backend development, frontend UI, performance optimization, database design, DevOps deployment"
thinking: high
tools: bash, edit, fetch_content, mcp, read, subagent, web_search, write
skills: moai-foundation-core, moai-foundation-quality, moai-platform-auth
systemPromptMode: replace
inheritProjectContext: true
inheritSkills: false
---

# Generated MoAI pi agent: expert-security

Source: .pi/generated/source/agents/moai/expert-security.md
Source hash: 2eade9ea5705ca82
...
- Read skill 'moai-platform-auth' from .pi/generated/source/skills when relevant.
